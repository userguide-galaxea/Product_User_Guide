...
## 硬件架构
![A1XY_hardware_structure_cn](./assets/A1XY_hardware_structure_cn.png)
...
![A1X_joint_tag_cn](./assets/A1X_joint_tag_cn.png)
...
![A1X_joint_angle_cn](./assets/A1X_joint_angle_cn.png)
...
![A1Y_joint_angle_cn](./assets/A1Y_joint_angle_cn.png)
...
![A1XY_base_cn](./assets/A1XY_base_cn.png)
...
<span style="color: blue;">**注意：A1XY机械臂不包括夹爪。如有需要，请联系我们购买。**</span>

![G1_size_cn](./assets/G1_size_cn.png)
...
![A1XY_install_gripper_cn](./assets/A1XY_install_gripper_cn.png)
...
![A1XY_install_ee_cn](./assets/A1XY_install_ee_cn.png)

1. **对齐检查：**使用特制转接件法兰，将法兰和灵巧手周围的4个安装孔对齐，以及将法兰与机械臂末端周围的3个安装孔对齐。<span style="color: blue;">（法兰.stp文件可联系support@galaxea.ai获取）</span>
