...
![R1L_3_takeout_chassis_cn](./assets/R1Lite_Unboxing_cn/R1L_3_takeout_chassis_cn.png)

- 底盘正面有一个电源开关和电池充电口（2芯）。
- 底盘内部装有一个6芯航插线和一个2芯航插线，用于连接底盘和躯干。
- 底盘背面有一个交流电充电口（3芯），如您的机器人未配置电池模块，机器人需接入交流电才可以正常启动。

![R1L_3_chassis_cn](./assets/R1Lite_Unboxing_cn/R1L_3_chassis_cn.png)
...
![R1L_4.1_takeout_torso_cn](./assets/R1Lite_Unboxing_cn/R1L_4.1_takeout_torso_cn.png)

### 4.2 连接底盘和躯干线束
将底盘内部的6芯航插头和2芯航插头分别接入躯干上的对应接口。

![R1L_4.2_connect_torso_cn](./assets/R1Lite_Unboxing_cn/R1L_4.2_connect_torso_cn.png)


### 4.3 固定躯干
<span style="color: red;">注意：为方便您连接线束， 建议您先进行第3节接入航空插头后再将躯干放进底盘。</span>

使用4颗M6x16螺钉将躯干安装到底盘内部，并按下图所示的位置固定。

![R1L_4.3_secure_torso_cn](./assets/R1Lite_Unboxing_cn/R1L_4.3_secure_torso_cn.png)

<span style="color: red;">注意：请确保使用的是M6x16型号的螺钉。使用不正确的型号可能会导致组件损坏。</span>
...
![R1L_5_install_battery_cn](./assets/R1Lite_Unboxing_cn/R1L_5_install_battery_cn.png)
...
![R1L_7_torso_stand_cn](./assets/R1Lite_Unboxing_cn/R1L_7_torso_stand_cn.png)

## 8. 安装平台
将平台从包装箱中取出，并按照图示的方式，使用4颗M6x8螺钉将平台固定在躯干顶端。

![R1L_8_install_platform_cn](./assets/R1Lite_Unboxing_cn/R1L_8_install_platform_cn.png)

<span style="color: red;">注意：请确保使用的是M6x8型号的螺钉。使用不正确的型号可能会导致组件损坏。</span>
