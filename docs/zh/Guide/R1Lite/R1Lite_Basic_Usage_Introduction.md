...
![R1L_hard_switch_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_hard_switch_cn.png)

### 软开关
R1 Lite躯干顶端处配备了一个银色圆形电源按钮：

![R1L_soft_switch_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_soft_switch_cn.png)
...
![R1L_battery_charge_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_battery_charge_cn.png)
...
![R1L_battery_change_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_battery_change_cn.png)
...
![R1L_estop_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_estop_cn.png)

## 遥控器使用说明
R1 Lite共有3个遥控器来分别控制机器人的躯干、底盘和紧急停止。请按照以下说明，使用适当的遥控器来完成不同的任务。
![R1L_torso_estop_controllers_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_torso_estop_controllers_cn.png)
![R1L_joystick_controller_cn](./assets/R1Lite_Basic_Usage_Introduction_cn/R1L_joystick_controller_cn.png)

<span style="color: red;">**注意：在遥控底盘之前，请确认遥控器的4个拨杆开关（SWA/SWB/SWC/SWD）都已拨至最上方档位，使R1 Lite处于停止状态，防止其意外运行。**</span>
