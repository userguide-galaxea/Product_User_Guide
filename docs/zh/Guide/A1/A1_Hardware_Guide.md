...
[灵巧手](../../Introducing_Galaxea_Robot/product_info/Dexterous_Hands.md)拥有一定的握持力和适中的速度，适合于机器人或假肢应用中的抓取和操纵任务。其结合了力量和控制，可以有效地处理各种物体，从而增强了机器人或假肢执行复杂任务的功能。
...
## 下一步
Galaxea A1的产品硬件介绍到这里就结束了。我们建议您继续探索[Galaxea A1产品软件介绍](./A1_Software_Guide.md)以获取更多详细信息。