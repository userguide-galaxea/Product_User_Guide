# R1 Pro Teleop 同构遥操作 ROS2使用说明
请下载[ROS2 SDK](./R1Pro_Teleop_Usage_Tutorial.md)并使用Ubuntu22.04系统，即可执行以下操作。
...
3. 连接后显示“设备已连接”。输入以下命令确认是否连接成功：
   ...
   ```
    ...
    ![R1Pro-T_2.4.2_grep_js_cn](./assets/r1prot/R1Pro-T_2.4.2_grep_js_cn.png)
...
![R1Pro-T_3.1_ros2_r1prosdk_cn](./assets/r1prot/R1Pro-T_3.1_ros2_r1prosdk_cn.png)
