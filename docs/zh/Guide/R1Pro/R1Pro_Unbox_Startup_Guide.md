...
![R1Pro_2.1_2.2_unlock_cn](./assets/unbox/R1Pro_2.1_2.2_unlock_cn.png)
...
![R1Pro_2.3_2.4_pullout_cn](./assets/unbox/R1Pro_2.3_2.4_pullout_cn.png)
...
![R1Pro_2.5_chassis_fix_cn](./assets/unbox/R1Pro_2.5_chassis_fix_cn.png)
...
![R1Pro_2.6_wheel_fix_cn](./assets/unbox/R1Pro_2.6_wheel_fix_cn.png)
...
![R1Pro_3.2_poweron_cn](./assets/unbox/R1Pro_3.2_poweron_cn.png)
...
![R1Pro_3.2.2_battery_install_cn](./assets/unbox/R1Pro_3.2.2_battery_install_cn.png)
...
2. 如果显示“self-check completed”，如下图所示，表示自检完成，请按`Ctrl + C`退出。
   ![R1Pro_4.4_1stcheck_cn](./assets/unbox/R1Pro_4.4_1stcheck_cn.png)

3. <span style="color:red;">如果出现警告，如下图所示，请及时联系我们提供技术支持。</span>
   ![R1Pro_4.4_1stcheck_error_cn](./assets/unbox/R1Pro_4.4_1stcheck_error_cn.png)
...
输入`5`然后按下`Enter`，R1 Pro将站立，按`q`即可退出Demo脚本。
![R1Pro_4.5.3_torso_control_5_cn](assets/unbox/R1Pro_4.5.3_torso_control_5_cn.png)
...
![R1Pro_5.1_remove_rear_cn](./assets/unbox/R1Pro_5.1_remove_rear_cn.png)

### 5.2 拆卸前侧盖板
使用L型六角扳手（M5）卸除胸腔两侧的六个M5螺钉，如下图所示。

![R1Pro_5.2_remove_front_cn](./assets/unbox/R1Pro_5.2_remove_front_cn.png)
...
![R1Pro_5.4_install_gripper_cn](./assets/unbox/R1Pro_5.4_install_gripper_cn.png)
