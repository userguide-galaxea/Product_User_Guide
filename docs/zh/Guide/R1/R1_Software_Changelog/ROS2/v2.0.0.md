...
3. <span style="color:red;">**本次迁移仅包含R1本体（R1Body）的相关模块，支持功能与[R1 ROS 1 Noetic SDK V1.1.4](../ROS1/v1.1.4.md) 保持一致。**</span>遥操作、导航等功能的ROS 2 版本正在迁移中，敬请关注后续更新！


## 更新说明

1. 在升级过程中，请不要中止系统运行，也不要进行任何控制操作，否则可能导致升级失败，影响系统正常使用。
2. 升级完成后，请关闭R1电源，并重新进行上电操作，以确保系统更新完全生效。
...
- 百度云：[R1 SDK V2.0.0](https://pan.baidu.com/s/1nKDaqJVQ2-4OlUaE0f7tIw?pwd=V200)
