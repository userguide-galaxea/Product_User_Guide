...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
        ...
        <tr style="background-color: white; text-align: left;">
            ...
            <td style="padding: 8px; border: 1px solid #ddd;">单臂5KG</td>
        </tr>
        <tr style="background-color: white; text-align: left;">
            <td style="padding: 8px; border: 1px solid #ddd;">重量</td>
...
如需了解更多信息，请参考[Galaxea A1 User Guide](http://galaxea.tech/Guide/A1/Getting_Started/)。
...
**Galaxea R1**硬件指南已经介绍完毕。如需了解其他详细信息，请参阅**Galaxea R1**软件指南。