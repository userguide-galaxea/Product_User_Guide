...
![R1PRO_title](../product_images_video/R1PRO_title.png)

## Precision and Flexibility

Galaxea R1 is a full-size Dual-Arm Humanoid Robot humanoid robot with a wide vertical operating range of up to 2 m and a horizontal operating radius of 700 mm. It is fitted with two 6-DoF lightweight and highly dynamic  [Galaxea A1](A1.md) robot arms and two [Galaxea G1](A1_accessory_G1.md) grippers, a 4-DoF torso and a three-wheel steering vector chassis, ensuring exceptional maneuverability and adaptability across diverse operational environments.

## Key Hardware Features

![R1_key_features](../product_images_video/R1_key_features.png)
...
If you wish to learn more about the hardware and software specifics of Galaxea R1, please refer to the [Galaxea  R1 User Guide](../../Guide/R1/R1_Overview.md) for detailed information.
