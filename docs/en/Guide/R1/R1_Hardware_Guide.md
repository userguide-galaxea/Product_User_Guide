...
See [Galaxea A1 User Guide](../A1/A1_Getting_Started.md) if you want to explore more.
...
## Next Step
This concludes the hardware guide for Galaxea R1. For further details, please refer to [Galaxea R1 Software Guide](./R1_Software_Guide.md).