...
<span style="color: red;">Note: To ensure proper operation, place R1 in a dry, well-ventilated environment with no obstructions or hazardous items around.</span>
...
1. Click "Settings" and connect to WiFi.
   ![3.3_obtain_ip_address](assets/3.3_obtain_ip_address.png)
...
3. If the connection is successful, disconnect the HDMI and USB cables and close the peripheral interface covers on the chassis and torso to avoid hindering the range of motion.
4. Then proceed to [section 4.3 Start CAN Driver](#43-start-can-driver).

<span style="color: blue;">**If the connection fails, please contact us in time for technical support.**</span>
