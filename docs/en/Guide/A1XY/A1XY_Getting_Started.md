...
## Power On
![A1XY_poweron](./assets/A1XY_poweron.png)
...
<span style="color:red;">Note: A1XY does not have brakes on its joint motors. Powering off the circuit may cause the robot arm to drop suddenly. Ensure the surrounding environment is safe during operation to prevent accidental injury or equipment damage. </span>
