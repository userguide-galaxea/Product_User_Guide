...
![A1XY_hardware_structure_cn](./assets/A1XY_hardware_structure.png)
...
![A1X_joint_tag_cn](./assets/A1X_joint_tag.png)
...
![A1X_joint_angle_cn](./assets/A1X_joint_angle.png)
...
![A1Y_joint_angle_cn](./assets/A1Y_joint_angle.png)
...
![A1XY_base_cn](./assets/A1XY_base.png)
...
<span style="color: blue;">**Note: The A1XY robot arm does not include the gripper. If needed, please contact us to purchase.**</span>

![G1_size_cn](./assets/G1_size.png)
...
![A1XY_install_gripper_cn](./assets/A1XY_install_gripper.png)
...
![A1XY_install_ee_cn](./assets/A1XY_install_ee.png)

1. **Alignment Check:** Use a custom adapter flange to align the 4 mounting holes around the dexterous hand and the 3 mounting holes around the flange with the 3 mounting holes at the end of the robot arm. <span style="color: blue;">(Note: The robot arm's joints will have a 2° position limit protection within their operational range.)</span>
