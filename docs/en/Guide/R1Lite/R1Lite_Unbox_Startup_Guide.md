# R1 Lite Unbox and Startup Guide
...
![R1L_3_takeout_chassis](./assets/R1Lite_Unboxing/R1L_3_takeout_chassis.png)
...
![R1L_3_chassis](./assets/R1Lite_Unboxing/R1L_3_chassis.png)
...
![R1L_4.1_takeout_torso](./assets/R1Lite_Unboxing/R1L_4.1_takeout_torso.png)
...
![R1L_4.2_connect_torso](./assets/R1Lite_Unboxing/R1L_4.2_connect_torso.png)

### 4.3 Secure the Torso
<span style="color: red;">Note: For easier wiring, it's recommended to connect the aviation plugs first (as in Section 3) before placing the torso into the chassis.</span>

Use four M6x16 screws to secure the torso inside the chassis, as shown.

![R1L_4.3_secure_torso](./assets/R1Lite_Unboxing/R1L_4.3_secure_torso.png)

<span style="color: red;">Note: Ensure you use M6x16 screws. Incorrect ones may damage components.</span>
...
![R1L_5_install_battery](./assets/R1Lite_Unboxing/R1L_5_install_battery.png)
...
![R1L_7_torso_stand](./assets/R1Lite_Unboxing/R1L_7_torso_stand.png)
...
![R1L_8_install_platform](./assets/R1Lite_Unboxing/R1L_8_install_platform.png)

<span style="color: red;">Note: Use M6x8 screws. Incorrect ones may damage components.</span>
