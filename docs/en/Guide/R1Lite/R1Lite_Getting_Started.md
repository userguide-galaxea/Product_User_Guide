...
![R1L_hard_switch](./assets/R1Lite_Basic_Usage_Introduction/R1L_hard_switch.png)
...
![R1L_soft_switch](./assets/R1Lite_Basic_Usage_Introduction/R1L_soft_switch.png)
...
![R1L_battery_charge](./assets/R1Lite_Basic_Usage_Introduction/R1L_battery_charge.png)
...
![R1L_battery_change](./assets/R1Lite_Basic_Usage_Introduction/R1L_battery_change.png)
...
<span style="color: red;">**Note: Ensure that the emergency stop button is in the released state when powering on the device.**</span>

![R1L_estop](./assets/R1Lite_Basic_Usage_Introduction/R1L_estop.png)
...
![R1L_torso_estop_controllers](./assets/R1Lite_Basic_Usage_Introduction/R1L_torso_estop_controllers.png)
![R1L_joystick_controller](./assets/R1Lite_Basic_Usage_Introduction/R1L_joystick_controller.png)
...
![R1L_chassis_control](./assets/R1Lite_Basic_Usage_Introduction/R1L_chassis_control.png)
