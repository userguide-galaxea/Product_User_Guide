...
![R1Pro_2.1_2.2_unlock](./assets/unbox/R1Pro_2.1_2.2_unlock.png)
...
![R1Pro_2.3_2.4_pullout](./assets/unbox/R1Pro_2.3_2.4_pullout.png)
...
![R1Pro_2.5_chassis_fix](./assets/unbox/R1Pro_2.5_chassis_fix.png)
...
![R1Pro_2.6_wheel_fix](./assets/unbox/R1Pro_2.6_wheel_fix.png)
...
![R1Pro_3.2_poweron](./assets/unbox/R1Pro_3.2_poweron.png)
...
![R1Pro_3.2.2_battery_install](./assets/unbox/R1Pro_3.2.2_battery_install.png)
...
1. Click "Settings" and connect to WiFi.
    ...
    ![R1Pro_4.2.1_ip](./assets/unbox/R1Pro_4.2.1_ip.png)
...
3. Find`mlan0`. The IP address of R1 Orin is: `192.xxx.xxx.xxx`.
    ![R1Pro_4.2.1_wifi](./assets/unbox/R1Pro_4.2.1_wifi.png)
...
2.  If it shows "self-check completed" as shown below, press `Ctrl + C` to exit. 
   ![R1Pro_4.4_1stcheck](./assets/unbox/R1Pro_4.4_1stcheck.png)

3. <span style="color:red;">If it appears warning, please contact us in time for technical support. </span>
   ![R1Pro_4.4_1stcheck_error](./assets/unbox/R1Pro_4.4_1stcheck_error.png)
...
![R1Pro_5.1_remove_rear](./assets/unbox/R1Pro_5.1_remove_rear.png)

### 5.2 Detach Front Cover
Use the L-hex key (M5) to remove six M5 screws on two sides of the chest, as boxed in the figure.

![R1Pro_5.2_remove_front](./assets/unbox/R1Pro_5.2_remove_front.png)
...
2. Use the hex L-shaped wrench (5mm) and four M6 screws to secure the arm. 
   ...
   ![R1Pro_5.3_arm_install](./assets/unbox/R1Pro_5.3_arm_install.png)
...
3. Connect the power cable and CAN cable of the robotic arm to the ports on the arm base. 
   ...
   ![R1Pro_5.3_arm_cable](./assets/unbox/R1Pro_5.3_arm_cable.png)
...
![R1Pro_5.4_install_gripper](./assets/unbox/R1Pro_5.4_install_gripper.png)
